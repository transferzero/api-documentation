...
| 34 | /// | Duplicate Transaction | Duplicate Transaction | This is the case of a possible duplicate transaction, Kindly retry this transaction in the next 15 minutes. You can also edit or cancel this transaction. | temporary_error |
