...
| 433 | /// | /// | User has not taken any actions for the pending funds | User has not taken any actions and the window for it has now expired. You can cancel this transaction. | recipient_error |
